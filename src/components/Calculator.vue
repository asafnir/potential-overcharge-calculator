            ...
            <template v-slot:default>
              <thead>
                <tr>
                  ...
                  <th class="text-left">Required IAI (Building under 35 Units)</th>
    ...
    methods: {
      ...
      calculateRenewal(index) {
        ...
        const item = this.rgb.find((r) => {
          return (moment(date).isAfter(r.startDate) && moment(date).isBefore(r.endDate))
        })
        if (item) {
